...
./$1.sh is_prime 5 16384 32768 66536 131072 262144
...
#./$1.sh kmeans 5 100000 200000 300000 400000 500000
#./$1.sh permutations 5 6 7 8 9 10
#./$1.sh mandlebrot 5 500 600 700 800 900 1000
#./$1.sh fft 5 128 256 1,024 4,096 8,192
...
#./$1.sh kmeans 5 "10000 10" "100000 10" "1000000 10" "1000000 20" "1000000 50"
#./$1.sh cholesky 5 65536 262144
#./$1.sh deconvolution 5 256 512 1024 2048
#./$1.sh euler_method 5 16384 32768 65536
